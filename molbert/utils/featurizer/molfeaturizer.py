...
class PhysChemFeaturizer(RDKitFeaturizer):
    ...
    @staticmethod
    def get_all_descriptor_names(rdkit=False) -> List[str]:
        """
        ...
        if rdkit:
            ...
            all_list = []
            all_list += PhysChemFeaturizer.get_simple_descriptor_subset()
            all_list += PhysChemFeaturizer.get_uncorrelated_descriptor_subset()
            all_list += PhysChemFeaturizer.get_fragment_descriptor_subset()
            all_list += PhysChemFeaturizer.get_graph_descriptor_subset()
            all_list += PhysChemFeaturizer.get_surface_descriptor_subset()
            all_list += PhysChemFeaturizer.get_druglikeness_descriptor_subset()
            all_list += PhysChemFeaturizer.get_logp_descriptor_subset()
            all_list += PhysChemFeaturizer.get_refractivity_descriptor_subset()
            all_list += PhysChemFeaturizer.get_estate_descriptor_subset()
            all_list += PhysChemFeaturizer.get_charge_descriptor_subset()
            all_list += PhysChemFeaturizer.get_general_descriptor_subset()
