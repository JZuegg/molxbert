...
#from transformers.models.transfo_xl import Embedding
...
class MolbertModel(pl.LightningModule):
    def __init__(self, args: Namespace):
        ...
        for key in args_dict.keys():
            self.hparams[key]=args_dict[key]
    ...
    def on_training_epoch_end(self, outputs) -> Dict[str, Dict[str, torch.Tensor]]:
        # OPTIONAL
    ...
    #def on_validation_epoch_end(self, outputs) -> Dict[str, Dict[str, torch.Tensor]]:
        # OPTIONAL
